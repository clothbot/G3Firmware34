...
//Bit 3 is strangle enabled (used to constain axis to Max Speed Change with Non Accelerated Mode)
...
const static uint16_t ACCEL_MIN_PLANNER_SPEED	= 0x0163;
const static uint16_t ACCEL_ADVANCE_K		= 0x0167;
const static uint16_t ACCEL_NOODLE_DIAMETER	= 0x016B;
const static uint16_t ACCEL_MIN_SEGMENT_TIME	= 0x016F;
...
//uint32_t (4 bytes)
const static uint16_t ACCEL_REV_MAX_FEED_RATE	= 0x0181;
const static uint16_t ACCEL_EXTRUDER_DEPRIME	= 0x0185;
const static uint16_t ACCEL_SLOWDOWN_LIMIT	= 0x0189;
const static uint16_t ACCEL_CLOCKWISE_EXTRUDER	= 0x018D;

//uint8_t (1 byte)
const static uint16_t INVERTED_EXTRUDER_5D	= 0x0191;
