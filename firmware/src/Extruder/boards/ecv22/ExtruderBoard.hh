...
public:
    static ExtruderBoard& getBoard()
    {
        return extruder_board;
    }
...
public:
    ...
    Heater& getExtruderHeater()
    {
        return extruder_heater;
    }
    Heater& getPlatformHeater()
    {
        return platform_heater;
    }
